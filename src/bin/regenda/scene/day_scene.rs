...
const STALE_BANNER_HEIGHT: u32 = 30;
...
impl Scene for DayScene {
    ...
    fn draw(&mut self, canvas: &mut Canvas) {
        ...
        // below the header with a light background so it reads clearly on
        // the Move's small display. Events shift down by STALE_BANNER_HEIGHT
        // only while stale — no layout shift once a successful refresh
        // arrives.
